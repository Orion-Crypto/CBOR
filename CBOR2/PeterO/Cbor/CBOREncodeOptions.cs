...
namespace PeterO.Cbor2
{
    ...
    public sealed class CBOREncodeOptions
    {
        ...
        public static readonly CBOREncodeOptions Default = new CBOREncodeOptions();
        ...
        public static readonly CBOREncodeOptions DefaultCtap2Canonical = new CBOREncodeOptions(
            "ctap2canonical=true"
        );

        /// <summary>Default options for CBOR objects. Disallow duplicate keys,
        /// and always encode strings using indefinite-length encoding.</summary>
        public static readonly CBOREncodeOptions UseIndefiniteLengthArrays = new CBOREncodeOptions(
            "useindeflengtharrays=true"
        );

        /// <summary>Initializes a new instance of the
        /// <see cref='PeterO.Cbor2.CBOREncodeOptions'/> class with all the
        /// default options.</summary>
        public CBOREncodeOptions() : this(String.Empty) { }

        /// <summary>Initializes a new instance of the
        /// <see cref='PeterO.Cbor2.CBOREncodeOptions'/> class.</summary>
        ...
        public CBOREncodeOptions(string paramString)
        {
            ...
            this.UseIndefLengthStrings = parser.GetBoolean("useindeflengthstrings", false);
            this.UseIndefLengthArrays = parser.GetBoolean("useindeflengtharrays", false);
            this.Float64 = parser.GetBoolean("float64", false);
        ...
        public override string ToString()
        {
            return new System.Text.StringBuilder()
                ...
                .Append(";useindeflengtharrays=")
                .Append(this.UseIndefLengthArrays ? "true" : "false")
                .Append(";float64=")
                .Append(this.Float64 ? "true" : "false")
        ...
        /// <summary>Gets a value indicating whether to encode arrays with an
        /// indefinite-length encoding under certain circumstances.</summary>
        /// <value>A value indicating whether to encode strings with an
        /// indefinite-length encoding under certain circumstances. The default
        /// is false.</value>
        public bool UseIndefLengthArrays { get; private set; }
