...
namespace PeterO.Cbor2 {
  ...
  internal sealed class CharacterReader : ICharacterInput {
    ...
    // <see cref='PeterO.Cbor2.CharacterReader'/> class.</summary>
    ...
    // <summary>Initializes a new instance of the
    // <see cref='PeterO.Cbor2.CharacterReader'/> class; will read the
    ...
    // <summary>Initializes a new instance of the
    // <see cref='PeterO.Cbor2.CharacterReader'/> class; will skip the
