...
namespace PeterO.Cbor2 {
  ...
  public sealed class JSONOptions {
    ...
    /// <see cref='PeterO.Cbor2.JSONOptions'/> class with default
    /// options.</summary>
    public JSONOptions() : this(String.Empty) {
    }

    /// <summary>Initializes a new instance of the
    /// <see cref='PeterO.Cbor2.JSONOptions'/> class with the given value
    ...
    /// <summary>Initializes a new instance of the
    /// <see cref='PeterO.Cbor2.JSONOptions'/> class with the given values
...
#pragma warning disable CS0618
    ...
    /// <summary>Initializes a new instance of the
    /// <see cref='PeterO.Cbor2.JSONOptions'/> class.</summary>
